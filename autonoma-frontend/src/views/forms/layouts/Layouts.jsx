...
const inputSlotProps = { typography: { sx: { mb: { xs: -0.5, lg: -0.25 } } } };
          ...
          <Grid container spacing={2} sx={{ alignItems: 'center' }}>
            ...
            <Grid size={12}>
              ...
              <Grid container spacing={2} sx={{ alignItems: 'center' }}>
                ...
                <Grid size={{ xs: 12, sm: 9, lg: 6 }}>
                  <FormControlLabel slotProps={inputSlotProps} control={<Checkbox defaultChecked />} label="English" />
                  <FormControlLabel slotProps={inputSlotProps} control={<Checkbox />} label="French" />
                  <FormControlLabel slotProps={inputSlotProps} control={<Checkbox />} label="Dutch" />
                </Grid>
              </Grid>
            </Grid>
          </Grid>
