              ...
              <Grid container spacing={gridSpacing} sx={{ alignItems: 'center' }}>
                <Grid>
                  <Box
                    sx={{
                      ...sideAvatarSX,
                      bgcolor: withAlpha(theme.vars.palette.primary.dark, 0.1),
                      color: 'primary.dark',
                      ...theme.applyStyles('dark', { border: '1px solid', borderColor: 'primary.main' })
                    }}
                  >
                ...
                <Grid size="grow">
                  <Typography variant="h3" sx={{ mb: 0.625, color: 'primary.main' }}>
                    239k
                  </Typography>
              ...
              <Grid container spacing={gridSpacing} sx={{ alignItems: 'center' }}>
                <Grid>
                  <Box
                    sx={{
                      ...sideAvatarSX,
                      bgcolor: withAlpha(theme.vars.palette.secondary.dark, 0.1),
                      color: 'secondary.dark',
                      ...theme.applyStyles('dark', { border: '1px solid', borderColor: 'secondary.main' })
                    }}
                  >
