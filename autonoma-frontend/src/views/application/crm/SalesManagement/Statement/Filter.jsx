...
export default function Filter({ rows, setRows }) {
  ...
  return (
    <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ justifyContent: 'space-between', alignItems: 'center', p: 3, gap: 2 }}>
      <TextField
      ...
      />
      <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between', width: { xs: 1, sm: 'auto' }, gap: 1.25 }}>
