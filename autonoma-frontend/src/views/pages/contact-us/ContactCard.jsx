        ...
        <Grid sx={{ mt: { md: 12.5, xs: 2.5 }, mb: { md: 12.5, xs: 2.5 } }} size={{ sm: 10, md: 7 }}>
          <Grid container spacing={gridSpacing}>
            ...
            <Grid size={12}>
              <Typography
                variant="h4"
                sx={{ color: 'common.white', fontWeight: 400, lineHeight: 1.4, my: { xs: 'auto', md: 0 }, mx: { xs: 'auto', md: 12.5 } }}
              >
                  ...
                  <Grid container spacing={gridSpacing}>
                    <Grid size={{ sm: 'grow' }}>
                      <Typography align="left" variant="body2">
                        ...
                        <Typography variant="subtitle1" component={Link} to="#" sx={{ mx: 0.5, color: 'primary.main' }}>
                          Privacy Policy
                        </Typography>
                        and
                        <Typography variant="subtitle1" component={Link} to="#" sx={{ ml: 0.5, color: 'primary.main' }}>
                          Cookie Policy
                        </Typography>
                      </Typography>
                    </Grid>
