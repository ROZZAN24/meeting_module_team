...
import SliderLight7 from 'assets/images/landing/pre-apps/slider-light-1.png';
import SliderDark7 from 'assets/images/landing/pre-apps/slider-dark-1.png';
...
import SliderLight9 from 'assets/images/landing/pre-apps/slider-light-1.png';
import SliderDark9 from 'assets/images/landing/pre-apps/slider-dark-1.png';
import SliderLight10 from 'assets/images/landing/pre-apps/slider-light-2.png';
import SliderDark10 from 'assets/images/landing/pre-apps/slider-dark-2.png';
import SliderLight11 from 'assets/images/landing/pre-apps/slider-light-3.png';
import SliderDark11 from 'assets/images/landing/pre-apps/slider-dark-3.png';
  ...
  return (
    <IconButton
      ...
      sx={{
        ...
        top: 'calc(50% - 70px)',
        cursor: 'pointer',
        bgcolor: `${theme.vars.palette.background.paper} !important`,
      ...
      aria-label="button"
    >
      <IconChevronRight fontSize={25} color={theme.vars.palette.grey[900]} />
    </IconButton>
  );
}
...
function SamplePrevArrow(props) {
  ...
  return (
    <IconButton
      ...
      aria-label="button"
    >
      <IconChevronLeft fontSize={25} color={theme.vars.palette.grey[900]} />
    </IconButton>
  );
}
    ...
    <>
      ...
      <Stack sx={{ pt: 1, gap: 1 }}>
        <Stack
          ...
          to={link}
          target="_blank"
          sx={{ alignItems: 'center', justifyContent: 'center', textDecoration: 'none', gap: 1 }}
        >
      ...
      <Grid container sx={{ justifyContent: 'center', px: 1.25, gap: 7.5 }}>
          ...
          <Grid container spacing={1.5}>
            ...
            <Grid size={12}>
              <Typography variant="h4" sx={{ fontWeight: 400 }} align="center">
                Berry has conceptual working apps like Chat, Mail, E-commerce, Invoice, Kanban, Calendar, CRM, and many more.
              </Typography>
            </Grid>
          </Grid>
        </Grid>
        <Grid size={12}>
          ...
          >
            ...
            >
              <Items title="Blog Dashboard" image={colorScheme === ThemeMode.DARK ? SliderDark1 : SliderLight1} link="/dashboard/blog" />
              <Items title="Calendar" image={colorScheme === ThemeMode.DARK ? SliderDark2 : SliderLight2} link="/apps/calendar" />
              <Items title="Chat App" image={colorScheme === ThemeMode.DARK ? SliderDark3 : SliderLight3} link="/apps/chat" />
              <Items
                title="User Contacts"
                image={colorScheme === ThemeMode.DARK ? SliderDark4 : SliderLight4}
                link="/apps/contact/c-card"
              />
              <Items title="CRM Dashboard" image={colorScheme === ThemeMode.DARK ? SliderDark5 : SliderLight5} link="/dashboard/crm" />
              <Items
                title="Customers"
                image={colorScheme === ThemeMode.DARK ? SliderDark6 : SliderLight6}
                link="/apps/customer/customer-list"
              />
              <Items
                title="E-commerce"
                image={colorScheme === ThemeMode.DARK ? SliderDark7 : SliderLight7}
                link="/apps/e-commerce/products"
              />
              <Items
                title="Invoice Management"
                image={colorScheme === ThemeMode.DARK ? SliderDark8 : SliderLight8}
                link="/dashboard/invoice"
              />
              <Items title="Kanban" image={colorScheme === ThemeMode.DARK ? SliderDark9 : SliderLight9} link="/apps/kanban/board" />
              <Items title="Mailbox" image={colorScheme === ThemeMode.DARK ? SliderDark10 : SliderLight10} link="/apps/mail" />
              <Items
                title="Social Profile"
                image={colorScheme === ThemeMode.DARK ? SliderDark11 : SliderLight11}
