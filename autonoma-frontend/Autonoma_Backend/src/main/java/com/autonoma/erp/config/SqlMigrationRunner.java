...
public class SqlMigrationRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("======================================");
        System.out.println("SQL MIGRATION STARTED");
        System.out.println("======================================");
        ...
        for (Resource resource : sortedResources) {
            ...
            try {
                ...
                insertFailedScript(fileName, e.getMessage());
            }
        }

        System.out.println("======================================");
        System.out.println("SQL MIGRATION COMPLETED");
        System.out.println("======================================");
    }
    ...
    private void insertFailedScript(String fileName, String errorMessage) {
