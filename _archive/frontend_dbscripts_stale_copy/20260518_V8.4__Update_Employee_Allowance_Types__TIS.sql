...
BEGIN
    ...
    UPDATE hrm_employee_master SET lom_allow = '0.00' WHERE lom_allow = 'NO' OR lom_allow = 'YES' OR lom_allow IS NULL OR TRIM(lom_allow) = '';
...
BEGIN
    ...
    UPDATE hrm_employee_master SET pf_restriction = '15000.00' WHERE pf_restriction = 'NO' OR pf_restriction = 'YES' OR pf_restriction IS NULL OR TRIM(pf_restriction) = '';
