...
import AddGradeDialog from './hr/AddGradeDialog';
...
export default function GradeDetails() {
  ...
  const fetchGrades = useCallback(async () => {
    ...
    try {
      ...
      dispatch(openSnackbar({ open: true, message: 'Failed to fetch grades.', variant: 'alert', alert: { variant: 'filled' }, severity: 'error', close: false }));
    } finally {
      setLoading(false);
    }
  }, [dispatch]);
