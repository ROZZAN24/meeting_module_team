  ...
  return (
    ...
    >
      <form onSubmit={formik.handleSubmit}>
        {/* add payment header */}
        <Box sx={{ p: 2.5, bgcolor: 'primary.light', ...theme.applyStyles('dark', { bgcolor: 'background.default' }) }}>
        ...
        {/* payment drawer */}
        <Dialog open={open} onClose={handleDialogToggler} slotProps={{ paper: { sx: { maxWidth: '100%', width: 980 } } }}>
