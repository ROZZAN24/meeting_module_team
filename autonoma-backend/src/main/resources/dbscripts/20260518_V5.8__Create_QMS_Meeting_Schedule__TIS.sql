...
IF OBJECT_ID('qms_meeting_schedule', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('qms_meeting_schedule_department', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('qms_meeting_schedule_participant', 'U') IS NULL
BEGIN
